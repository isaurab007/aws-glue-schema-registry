...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_glue_schema_registry_serializer(void * jarg1) {
  void * jresult ;
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_glue_schema_registry_deserializer(void * jarg1) {
  void * jresult ;
  glue_schema_registry_error **arg1 = (glue_schema_registry_error **) 0 ;
